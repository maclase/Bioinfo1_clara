...
fasta <- read.fasta("ChloroflexusCDS.ffn") #Leemos el archivo fasta
...
codon_mas_freq
#En este caso el codon de mayor frecuencia es el ctg (Leu)


#Se grafican las frecuencias de los codones en un grafico de barras
barplot(freqaa$Freq, names.arg = df$V3, cex.names = 0.6, 
        main = "Frecuencia de uso de codones", col = 7, ylab = "Frecuencia", xlab = "Codones")
